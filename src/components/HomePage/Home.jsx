      ...
      <div className="home bg-[#443C68] xl:flex border-b-2">
        ...
        <div className="h-[60%] flex flex-col justify-center xl:h-[93%] xl:w-[63%]">
          <div className="h-[50%] mt-[160px] mb-[15px] pb-0 xl:flex-col xl:ml-[13%] md:mt-[210px]">
            <p className="text-white text-3xl text-center md:pt-7 xl:m-[10px] xl:text-5xl md:text-4xl drop-shadow-2xl">
              Hi, I'm Shreya Kumar!
            </p>
            <p className="text-white font-bold text-xl xl:m-[10px] xl:text-3xl md:text-2xl xl:font-bold drop-shadow-2xl">
              <Typewriter
                words={[
                  "Software Developer", "Problem Solver", "MERN Stack Developer", "Frontend Developer", "Cloud Enthusiast", "Collaborative developer"
                ]}
                typingSpeed={120} // Slightly faster typing
                deletingSpeed={80} // Faster deleting
                pauseDuration={2000} // Longer pause at end of word
                className="text-white" // Additional styles for the typed text
              />
            </p>
            <button
              onClick={() => navigate("/resume")}
              className="res-btn w-[200px] h-[50px] bg-[#635985] hover:font-bold m-7 font-semibold rounded-md text-lg shadow-2xl"
            >
              Resume
            </button>
          </div>
